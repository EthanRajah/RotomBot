...
class ServiceTester(Node):
    def __init__(self):
        ...
        self.launch_client = self.create_client(Trigger, '/comm/launch')
        self.test_client   = self.create_client(Trigger, '/comm/test')
        self.land_client   = self.create_client(Trigger, '/comm/land')
        self.abort_client  = self.create_client(Trigger, '/comm/abort')
