...
class WaypointProcessorNode(Node):
    ...
    def __init__(self):
        ...
        self.lookup = {"A": [0.0, -0.95, 0.3, 0.0, 0.0, 0.707, 0.707], # 90 degree yaw
                       "B": [0.95, 0.0, 0.3, 0.0, 0.0, 1.0, 0.0], # 180 yaw
                       "C": [0.0, 0.95, 0.3, 0.0, 0.0, 0.707, -0.707], # 270 yaw
                       "D": [-0.95, 0.0, 0.3, 0.0, 0.0, 0.0, 1.0]} # 0 yaw
