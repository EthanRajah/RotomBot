...
: ${AMENT_CURRENT_PREFIX:="/home/jetson/ros2_ws/src/install/px4_autonomy_modules"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_autonomy_modules/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_autonomy_modules/environment/path.sh"
